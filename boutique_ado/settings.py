...
ALLOWED_HOSTS = ['online-store-walkthrough.herokuapp.com', 'localhost']
...
INSTALLED_APPS = [
    ...
    'allauth.account',  # allauth apps
    'allauth.socialaccount',  # allauth apps
...
if 'USE_AWS' in os.environ:
    AWS_STORAGE_BUCKET_NAME = 'online-store-walkthrough'
    ...
    STATIC_URL = f'https://{WS_S3_CUSTOM_DOMAIN}/{STATICFILES_LOCATION}/'
    MEDIA_URL = f'https://{WS_S3_CUSTOM_DOMAIN}/{MEDIAFILES_LOCATION}/'
